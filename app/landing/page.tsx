      ...
      <section id="pricing" className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg border-2 border-gray-200">
            ...
            <a 
              href="tel:+13184089163"
              className="block w-full bg-gray-600 hover:bg-gray-700 text-white py-3 rounded-lg font-bold text-center transition-colors"
            >
              Start Free
            </a>
          </div>
          ...
          <div className="bg-blue-600 text-white p-8 rounded-lg shadow-xl border-2 border-blue-700 relative">
            ...
            <ul className="space-y-3 mb-8">
              <li className="flex items-start">
                ...
                <span>Unlimited AI phone calls 24/7</span>
              </li>
              <li className="flex items-start">
                <span className="text-yellow-400 mr-2">✓</span>
                <span>Full alarm database (181+ codes)</span>
              </li>
              <li className="flex items-start">
                <span className="text-yellow-400 mr-2">✓</span>
